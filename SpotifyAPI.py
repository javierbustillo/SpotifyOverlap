...
class SpotifyAPI:
    ...
    tok = 'BQDHbWNwjO1DUc2X_V0X-4eIS4dwtaN94ha5ylg9j8gTzDwliVjuek_gpUNtE03PfPeb5WAqTjTrfhOtXGasLW5PcIb6GpgpGDWApaleKjbfhfcwlsR9Sye7manhBST57T0eu0Jp4abqoymDZGZ4cuUvXQgxIjyEd7NG_euwJE6Lhojna-A9wEHlQsboNWjzdzIrrd-Ed-vwfj1XIXmxpijAyWOGOiFi-up9BT055DbD4hcBh6SuZCT62VnQzWPCbJdimol0zOZ3jf9ejsY'
    ...
    def get_playlist_title(self, pid):
        return self.request_data('/playlists/%s' % pid, token=self.tok)["name"]
